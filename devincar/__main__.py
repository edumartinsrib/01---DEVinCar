            ...
            if opcao == "0":
                ...
                while True:
                    ...
                    if sub_opcao in menu.menu_relatorio_veiculos:
                        ...
                        menu.limpar_menu(console=console, tipo='input', texto="Opção inválida - Pressione qualquer tecla para voltar...", estilo='erro')
            elif opcao == "3":
                while True:
                    ...
                    if  veiculo_disponivel == True:
                        ...
                        if sub_opcao in menu.menu_modificacoes_veiculos:
                            while True:
                                if sub_opcao == "0":
                                    ...
                                    menu.barra_progresso('Alterando cor do veículo...')
                                    menu.limpar_menu(console=console, tipo='input', texto="Veículo alterado com sucesso!\nPressione qualquer tecla para voltar...", estilo='sucesso')
                                    break
                                elif sub_opcao == "2":
                                    veiculo.alterar_veiculo(db, 'valor')
                                    menu.barra_progresso('Alterando valor do veículo...')
                                    menu.limpar_menu(console=console, tipo='input', texto="Veículo alterado com sucesso!\nPressione qualquer tecla para voltar...", estilo='sucesso')
                                    break
                                elif sub_opcao == "3":
                                    menu.limpar_menu(console=console)
                        ...
                        menu.limpar_menu(console=console, tipo='input', texto="Veiculo não encontrado ou não disponível.", estilo='erro')
            elif opcao == "4":
                while True:
                    ...
                    if  veiculo_disponivel == True:
                            ...
                            menu.limpar_menu(console=console, tipo='input', texto="Veículo vendido com sucesso!", estilo='sucesso')
                    else:
                        menu.limpar_menu(console=console, tipo='input', texto="Veiculo não disponível - Pressione qualquer tecla para continuar...", estilo='erro')
                        continue
