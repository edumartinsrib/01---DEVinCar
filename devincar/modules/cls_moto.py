...
class MotoTriciclo(Veiculos):
    ...
    def cadastrar_veiculo(self, db):
        ...
        self.qtd_rodas = Validacoes.valida_inteiro(
            "Digite a quantidade de rodas do veiculo: ")
        super().salvar_veiculo(db)

    def carregamento_inicial(self, numero_chassi, data_fabricacao, nome, placa, valor, cpf_comprador, cor, potencia, qtd_rodas, data_venda, status):
